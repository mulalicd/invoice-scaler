...
- `2026-07-18 | DIRECTIVE | Sprint 10: 2FA (TOTP) enroll/challenge/unenroll kroz Supabase MFA API + "Odjavi sa svih uređaja" (global signOut). MfaChallenge integriran u ProtectedRoute. | sprints/SPRINT_10.md`
